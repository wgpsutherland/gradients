        ...
        knex('users')
            ...
            .then(function(userStuff) {
                ...
                return knex('user_institution_join')
                    ...
                    .insert({
                        user_id: userStuff[0],
                        institution_id: req.body.uni_choice
                    })
                    .then(function(iuStuff) {

                        return knex('course_institution_join')
                            .transacting(trx)
                            .insert({
                                user_id: userStuff[0],
                                course_id: req.body.course_choice,
                                current: true
                            })
...
var getGradesForUser = function(req, res) {
...
var getGradesForUserFromModule = function(req, res) {
    ...
    knex.transaction(function(trx) {
        ...
        var sentInfo = req.params.id.split('x');
...
module.exports.getGradesForUser = getGradesForUser;
