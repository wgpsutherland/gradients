...
var validate = function(req, res, next) {
    ...
    var req_token = utils.getCookie(req.headers.cookie, "auth_token");
    var req_userId = utils.getCookie(req.headers.cookie, "user_id");
    var req_username = utils.getCookie(req.headers.cookie, "username");
